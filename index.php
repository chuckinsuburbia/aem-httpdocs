...
(!isset($_REQUEST['sort'])) && $_REQUEST['sort'] = "";
...
<?php }else{ //else its an update 
if(isset($_GET['mode']) && $_GET['mode'] == 'mini'){
?>
<table align="center" border="0" cellspacing="0" cellpadding="1">
<tr>
  <th colspan="2">MouseOver for details</th>
</tr>
<?php
}else{
?>
<table align="center" border="0" cellspacing="0" cellpadding="1">
 <tr><td colspan="6"><div style="font-size:10px;text-align:right">(updated<?php echo date("m/d/Y H:i:s") ?>)<a href="javascript:updateAlerts();"><img src="images/refresh.png" width="16" height="16" border="0"/></a></div>
</td></tr>
  <tr>
    ...
    <th width=40>
     #
     <a href='<?php echo($_SERVER['PHP_SELF']);?>?sort=aa_count asc'>
      <img height='10' src='images/uparrow.gif' />
     </a>
     <a href='<?php echo($_SERVER['PHP_SELF']);?>?sort=aa_count desc'>
      <img height='10' src='images/downarrow.gif' />
     </a>
    </th>
    <th>IM</th>
    <th width=100>
     Time
     <a href='<?php echo($_SERVER['PHP_SELF']);?>?sort=aa_received_time asc'>
      <img height='10' src='images/uparrow.gif' />
     </a>
     <a href='<?php echo($_SERVER['PHP_SELF']);?>?sort=aa_received_time desc'>
      <img height='10' src='images/downarrow.gif' />
     </a>
    </th>
    <th>Contact</th>
...
$aad = getActiveAlerts($_REQUEST['sort']);
